...
-- Hotkey popup
    ...
    awful.key({ config.modkey, }, ",", function() awful.screen.focus_relative(1) end,
        { description = "focus the next screen", group = "awesome: general" }),

    -- Open a terminal
    awful.key({ config.modkey, }, "Return", function() awful.spawn(config.terminal) end,
        { description = "open a terminal", group = "awesome: general" }),
...
for i = 1, 5 do
    shortcuts.globalkeys = gears.table.join(shortcuts.globalkeys,
        ...
        awful.key({ config.modkey }, "#" .. i + 9,
            ...
            { description = "view tag #" .. i, group = "awesome: tags" }),
        ...
        awful.key({ config.modkey, "Control" }, "#" .. i + 9,
            ...
            { description = "toggle tag #" .. i, group = "awesome: tags" }),
        ...
        awful.key({ config.modkey, "Shift" }, "#" .. i + 9,
            ...
            { description = "move focused client to tag #" .. i, group = "awesome: tags" })
    )
end
...
-- Make client fullscreen
    awful.key({ config.modkey, }, "f",
        ...
        { description = "toggle fullscreen", group = "awesome: clients" }),

    -- Kill current client
    awful.key({ config.modkey, "Shift" }, "c", function(c) c:kill() end,
        { description = "close", group = "awesome: clients" }),
    ...
    awful.key({ config.modkey, }, ".", function(c) c:swap(awful.client.getmaster()) end,
        { description = "move to master", group = "awesome: clients" }),
    ...
    awful.key({ config.modkey, "Shift" }, ",", function(c)
        ...
        { description = "move to screen", group = "awesome: clients" }),
    ...
    awful.key({ config.modkey, }, "n",
        ...
        { description = "minimize", group = "awesome: clients" }),
    ...
    awful.key({ config.modkey, }, "m",
        ...
        { description = "(un)maximize", group = "awesome: clients" }),
    ...
    awful.key({ config.modkey, "Control" }, "m",
        ...
        { description = "(un)maximize vertically", group = "awesome: clients" }),
    ...
    awful.key({ config.modkey, "Shift" }, "m",
        ...
        { description = "(un)maximize horizontally", group = "awesome: clients" }),
    ...
    awful.key({ config.modkey, }, "j",
        ...
        { description = "focus next by index", group = "awesome: clients" }
    ),
    ...
    awful.key({ config.modkey, }, "Tab",
        ...
        { description = "go back", group = "awesome: clients" }),
    ...
    awful.key({ config.modkey, "Control" }, "n",
        ...
        { description = "restore minimized", group = "awesome: clients" })
