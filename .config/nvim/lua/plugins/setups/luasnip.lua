...
ls.add_snippets("java", {
  ...
  s("itco", fmt("for(Iterator {} = {}.iterator(); {}.hasNext(); ) {{\n\t{} {} = {}.next()\n\t{}\n}}", {
    i(1, "iterator"),
    i(2, "collection"),
    rep(1),
    i(3, "Object"),
...
ls.add_snippets("tex", {
  ...
  s("art", fmt("\\documentclass{}{{article}}\n{}", {
    c(1, {sn(nil, {t"[", i(1), t"]"}),t""}), i(0)})
  ),
})
